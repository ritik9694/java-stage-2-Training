...
public class BookServiceImpl implements BookService {
	...
	public Book saveBook(Book newBook) {
		 ...
		 * Book book = new Book();
		 * 
		 * book.setBookId(book.getBookId()); book.setBookTitle(book.getBookTitle());
		...
		try {
			...
			throw new BookNotFoundException("Failed to save book: "+ newBook,e);
		}
		/*Book bk=bookRepository.save(newBook);
		
		return bk;
		throw new BookNotFoundException("Book not posted by bookId"+newBook);*/
	}

...
import com.cognizant.boot.beans.Controller.VehicleController;
import com.cognizant.boot.beans.config.AppConfig;
...
public class Application {
   ...
   Application(VehicleController vehicleController, AppConfig appConfig) {
